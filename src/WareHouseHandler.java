...
public class WareHouseHandler implements ActionListener, WindowListener, MouseListener {
    ...
    public void init(){
        ...
        DateTimeFormatter date = DateTimeFormatter.BASIC_ISO_DATE.ofPattern("yyyy/MM/dd");
        view.gettxtDateOfTime().setText(date.format(LocalDateTime.now()));
    }
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource().equals(view.getBn1())){
            ...
            try {
                ...
                try (FileOutputStream stream = new FileOutputStream(logs);
    ...
    public void windowOpened(WindowEvent e) {
        if (logs.exists()) {
            try (FileInputStream stream = new FileInputStream(logs);
