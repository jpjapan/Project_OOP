...
public class WareHouseGUI {
    ...
    private JTextField txtName, txtAmount, txtPrice, txtCode, txtTotalOfProducts;
    private JLabel la1, la2, la3, la4, title1, la_TotalOfProducts;
    ...
    public WareHouseGUI() {
        ...
        txtTotalOfProducts = new JTextField(10);
        txtTotalOfProducts.setFont(new Font("Angsana New", Font.BOLD, 18));
        txtTotalOfProducts.setEditable(false);
        title1 = new JLabel("WareHouse");
        title1.setFont(new Font("Angsana New", Font.BOLD, 70));
        p7.add(title1);
        la_TotalOfProducts = new JLabel("Total");
        la_TotalOfProducts.setFont(new Font("Angsana New", Font.BOLD, 25));
        la1 = new JLabel("Name");
        ...
        p2.add(p5);
        p2.add(p4);
        p17.add(la_TotalOfProducts);
        p17.add(txtTotalOfProducts);
        p9.add(p14);
        p9.add(p15);
        p9.add(p16);
        //p9.add(p17);
    ...
    public JTextField getTxtTotalOfProducts() {
        return txtTotalOfProducts;
    }

    public void setTxtTotalOfProducts(JTextField txtTotalOfProducts) {
        this.txtTotalOfProducts = txtTotalOfProducts;
    }
